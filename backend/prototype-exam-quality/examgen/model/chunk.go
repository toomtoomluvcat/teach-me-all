...
// ClassifySourceRole exposes the same conservative structural hint to the
// gate package. The classification remains a model-independent source rule.
func ClassifySourceRole(text string) SourceRole { return classifySourceRole(text) }
